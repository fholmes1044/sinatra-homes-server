...
Home.create(title:"Peaceful City Stay", category:"Apartment", description: "calm city sounds with great views", price:157 , guest_capacity:4, location: "18 Calm Corner, Washington DC 12987", host_id:2)
